...
/**
 ...
 use DepTime,ArrTime,UniqueCarrier,FlightNum,ActualElapsedTime,ArrDelay,DepDelay,Origin,Dest,
 PRCP,TMAX,TMIN  as value.
...
public class Task1 extends Configured implements Tool {
  ...
  public static void main(String[] args) {
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setMapperClass(DelayJoinMapper.class);
        job.setReducerClass(DelayJoinReducer.class);
