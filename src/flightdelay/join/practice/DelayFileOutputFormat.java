...
public class DelayFileOutputFormat extends FileOutputFormat {
    @Override
    public RecordWriter<DateDelay, DelayWeather> getRecordWriter(TaskAttemptContext job) throws IOException, InterruptedException {
        ...
        return new DelayRecordWrite(out);
    }
}
